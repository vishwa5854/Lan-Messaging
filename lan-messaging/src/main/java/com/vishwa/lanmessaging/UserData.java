...
class UserData {
    ...
    private int countNumberOfLinesInFiles() throws IOException {
        FileReader fileReader = new FileReader("//predator/MessagingFiles/UserData.txt");
    ...
    private void renameFile(String loggedInUsername , String newUsername) {
        File file= new File("//predator/MessagingFiles/" + loggedInUsername + "_check_if_online.txt");
        File newFile = new File("//predator/MessagingFiles/" + newUsername + "_check_if_online.txt");
    ...
    void writeUserDataIntoFile() throws IOException {
        FileWriter fileWriter = new FileWriter("//predator/MessagingFiles/UserData.txt");
